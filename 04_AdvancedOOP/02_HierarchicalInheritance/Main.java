public class Main {
    public static void main(String[] args) {
        ...
        */
        /* 
        3. Heirarchical Inheritance: son and daughter (2 subclasses) inherited from father (super class)
        ...
        */
        ...
        // The overrided print function was inherited to the subclasses Sedan and Suv. 
        sedan_1.print();
        suv_1.print();
